...
def shortlink():
    if request.method == 'POST':
        ...
        if request.form['code'] in urls.keys():
            flash('That short name has already been taken. Choose another one.')
        ...
        return render_template('shortlink.html', code=request.form['code'])
    else:
        return redirect(url_for('index'))
